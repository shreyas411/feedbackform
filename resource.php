...
if(isset($_POST['sub']))
{
    ...
    $rname = $_SESSION['rname']; #resource person name 
    ...
    {
        ?>
        <form action="exportresource.php" method="post">
       <input name="download" type="submit" value="Download" style="margin-left:50px; margin-top:50px;">
        </form>
        <?php

         $sql = "SELECT * FROM `paper` where rname = '$rname'"; #select query where resource person name
