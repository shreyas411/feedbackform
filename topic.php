...
if(isset($_POST['sub']))
{
    ...
    $tname = $_SESSION['tname'];    #resource person name 
    ...
    {
        ?>
        <form action="exporttopic.php" method="post">
       <input name="download" type="submit" value="Download" style="margin-left:50px; margin-top:50px;">
        </form>
        <?php

         $sql = "SELECT * FROM `paper` where tname = '$tname'"; #select query where resource person name
