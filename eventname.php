...
if(isset($_POST['sub']))
{
    ...
    $event = $_SESSION['event']; #resource person name 
    ...
    {
        ?>
        <form action="exportevent.php" method="post">
       <input name="download" type="submit" value="Download" style="margin-left:50px; margin-top:50px;">
        </form>
        <?php

         $sql = "SELECT * FROM `paper` where event = '$event'"; #select query where resource person name
